...
//   {
//     name:'Blog Title',
//     desc:'An AI Tool to generate the blog by just giving prompt',
//     catg:'Blog',
//     icon:'blog.png',
//     aiPrompt:"Give Me 5 Blog Topic idea in Bullet wise only only based on given niche & outline topic and give me result  in Rich Text Editor Format ",
//     slug:'generate-blog-title' ,// unique for seo purpose
//     form:[
//       {
